    ...
    calculaValorTotalForm = () => {
        ...
        if (this.props.pedido.itens.length > 0) {
            this.props.pedido.itens.forEach(item => {
                ...
                temDesconto = !temDesconto && formatForCalc(item.vlr_desconto) > 0 ? true : temDesconto
            })
        }
                ...
                <View style={commonStyles.containerForm}>
                    <ScrollView>
                        <View>
                            ...
                            <View style={ styles.containerLinhaAddButton }>
                                <Button mode="contained" color='green' disabled={ this.state.item.vlr_total <= 0 } onPress={this.adicionaItem} >
                                    Incluir item  <Icon name='plus' size={20} color='white' />
                                </Button>
                            </View>
                            ...
                            <View style={ styles.containerItens }>
                                <Card>
                                    ...
                                    <Card.Content>
                                        ...
                                        <Text style={styles.textDatatableFooter}>R$ {this.state.vlrTotalForm}</Text>
                                    </Card.Content>
                                </Card>
                            </View>
                        
                            <Button mode="contained" color='blue' onPress={() => this.props.navigation.navigate('Faturamento')} disabled={this.state.vlrTotalForm == '0,00'} > 
                                Faturar   <Icon name='money' size={20} color='white' /> 
                            </Button>
                        </View>
                    </ScrollView>
                </View>
